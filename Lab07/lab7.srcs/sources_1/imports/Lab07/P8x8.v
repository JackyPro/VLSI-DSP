...
yin
	...
	input	clk, reset;
	output reg [WORD_SIZE*2-1:0]	pout;
	reg 	[6:0]DFF1;
	wire	[6:0]DFF;
	...
	always@(posedge clk)begin
	 if(reset)begin
	   ...
	   DFF1<={c61,c52,c43,c34,c25,c16,c07};
	end
	assign DFF=DFF1;
	...
	FA	U07( .a(p70 ), .b(p61), .c(p52), .sum(s07), .cout(c07) );//dff0 c07
	...
	FA	U16( .a(c06), .b(s07), .c(p43), .sum(s16), .cout(c16) );//dff1 c16
	FA	U17( .a(DFF[0]), .b(s08), .c(p53), .sum(s17), .cout(c17) );
//	FA	U17( .a(c07), .b(s08), .c(p53), .sum(s17), .cout(c17) );	
	...
	FA	U25( .a(c15), .b(s16), .c(p34), .sum(s25), .cout(c25) );//dff2 c25
	FA	U26( .a(DFF[1]), .b(s17), .c(p44), .sum(s26), .cout(c26) );
//	FA	U26( .a(c16), .b(s17), .c(p44), .sum(s26), .cout(c26) );
	...
	FA	U34( .a(c24), .b(s25), .c(p25), .sum(s34), .cout(c34) );//dff3 c34
	FA	U35( .a(DFF[2]), .b(s26), .c(p35), .sum(s35), .cout(c35) );
//	FA	U35( .a(c25), .b(s26), .c(p35), .sum(s35), .cout(c35) );
	...
	FA	U43( .a(c33), .b(s34), .c(p16), .sum(s43), .cout(c43) );//dff4 c43
	FA	U44( .a(DFF[3]), .b(s35), .c(p26), .sum(s44), .cout(c44) );
//	FA	U44( .a(c34), .b(s35), .c(p26), .sum(s44), .cout(c44) );
	...
	FA	U52( .a(c42), .b(s43), .c(p07), .sum(s52), .cout(c52) );//dff5 c52
	...
	FA	U61( .a(c51), .b(s52), .c(1'b0), .sum(s61), .cout(c61) );//dff6  c61
	FA	U62( .a(DFF[5]), .b(s53), .c(DFF[6]), .sum(s62), .cout(c62) );
